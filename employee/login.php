...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($username) || empty($password)) {
        ...
        if ($attempts >= 5) {
            ...
            // Get user - Must be employee
            $db->query("SELECT id, username, password, full_name, user_type, is_active 
                      FROM users WHERE username = :username AND user_type = 'employee' LIMIT 1");
            ...
            if ($user) {
                if (!$user['is_active']) {
                    ...
                    logActivity('Employee Login Successful', 'auth', $user['id']);
                    header("Location: dashboard.php");
                    exit();
                } else {
                ...
                $error = 'Invalid employee credentials. This login is for employees only.';
                logActivity('Login Failed - Unknown Employee', 'auth', null);
            }
        }
    }
}
...
<head>
    ...
    <title>Employee Login - <?php echo APP_NAME; ?></title>
    ...
    <div class="login-container">
        <div class="login-card">
            <div class="login-header">
                ...
                <span class="badge-emp">Employee Access</span>
            </div>
            ...
            <form method="POST" action="" autocomplete="off">
                ...
                <button type="submit" class="btn btn-login">
                    <i class="bi bi-box-arrow-in-right"></i> Sign In as Employee
                </button>
            </form>
