    ...
    if (empty($errors)) {
        try {
            ...
            if (!$account) {
                ...
                $errors[] = 'Insufficient balance. Available: ' . formatMoney($account['balance']);
            } else {
                $db->beginTransaction();
                ...
                setFlash('success', 'Withdrawal of ' . formatMoney($amount) . ' successful!');
                redirect('statement.php?account_id=' . $account_id);
            }
        } catch (Exception $e) {
            if (isset($db)) $db->rollback();
            error_log("Withdrawal Error: " . $e->getMessage());
            $errors[] = 'Failed to process withdrawal';
        }
    }
}
    ...
    <div class="col-md-6 mx-auto">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0"><i class="bi bi-dash-circle"></i> Make Withdrawal</h5>
            </div>
            <div class="card-body">
                <?php if (!empty($errors)): ?>
                ...
                <div class="alert alert-warning">
                    ...
                    <strong>Available Balance:</strong> <strong><?php echo formatMoney($account['balance']); ?></strong>
                </div>
                <?php endif; ?>
                ...
                <form method="POST" action="">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="amount" class="form-control form-control-lg" 
                               ...
                               max="<?php echo $account['balance'] ?? 0; ?>">
                    </div>
                    ...
                    <button type="submit" class="btn btn-warning btn-lg w-100"
                            onclick="return confirm('Confirm withdrawal of this amount?')">
