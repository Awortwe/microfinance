...
} elseif (in_array($current_dir, ['users', 'products', 'customers', 'loans', 'reports', 'settings', 'savings', 'collections'])) {
    $logout_path = '../logout.php';
...
// Profile and Help paths
if ($current_dir == 'admin' || $current_dir == 'employee') {
    $profile_path = '../shared/profile.php';
    $help_path = '../shared/help.php';
} elseif (in_array($current_dir, ['users', 'products', 'customers', 'loans', 'reports', 'settings', 'savings', 'collections'])) {
    $profile_path = '../../shared/profile.php';
    $help_path = '../../shared/help.php';
} elseif ($current_dir == 'shared') {
...
<div class="sidebar-wrapper">
    ...
    <nav class="sidebar-nav">
        ...
        <?php if ($is_admin): ?>
        <!-- ADMIN MENU -->
        <div class="nav-divider"><span>Management</span></div>
        ...
        <div class="nav-divider"><span>Loan Management</span></div>
        ...
        <div class="nav-divider"><span>Reports & Settings</span></div>
        ...
        <?php else: ?>
        <!-- EMPLOYEE MENU -->
        <div class="nav-divider"><span>Customers</span></div>
        ...
        <div class="nav-divider"><span>Savings (Susu)</span></div>
        ...
        <div class="nav-divider"><span>Collections & Reports</span></div>
        ...
        <div class="nav-divider"><span>Account</span></div>
